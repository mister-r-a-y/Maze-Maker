...
interface MazeControlState {
  grid: string | JSX.Element[]
  width: number,
  height: number
}
export default class MazeControl extends Component<MazeControlProps, MazeControlState> {
    constructor(props: MazeControlProps) {
      super(props);
    ...
    componentWillReceiveProps(nextProps: MazeControlProps) {
      const t = this
